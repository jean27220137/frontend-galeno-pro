    ...
    <div class="tw-flex tw-flex-col tw-min-h-[calc(100vh-64px)]">
      <nav class="gp-subnav">
        <div class="gp-subnav__inner">
          <span class="gp-subnav__module"><i class="pi pi-file tw-text-[#2378f0]"></i> Facturación</span>
...
export class FacturacionComponent {
  links = [
    { path: 'nueva',         label: 'Nueva Factura',     icon: 'pi pi-file-plus'  },
    { path: 'emitidas',      label: 'Facturas Emitidas', icon: 'pi pi-file'       },
    { path: 'notas-credito', label: 'Notas de Crédito',  icon: 'pi pi-file-minus' },
  ];
}
