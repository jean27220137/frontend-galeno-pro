...
@Component({
  ...
  template: `
    <div class="tw-flex tw-flex-col tw-min-h-[calc(100vh-64px)]">
      <nav class="gp-subnav" aria-label="Consulta Externa">
        <div class="gp-subnav__inner">
          <span class="gp-subnav__module"><i class="pi pi-users tw-text-[#2378f0]"></i> Consulta Externa</span>
...
export class ConsultaExternaComponent {
  links = [
    { path: 'paciente/registro', label: 'Pacientes',       icon: 'pi pi-user' },
    { path: 'citas/agenda',      label: 'Citas',           icon: 'pi pi-calendar' },
    { path: 'triaje',            label: 'Triaje',          icon: 'pi pi-heart' },
    { path: 'atenciones',        label: 'Atenciones',      icon: 'pi pi-stethoscope' },
    { path: 'gestor-colas',      label: 'Gestor de Colas', icon: 'pi pi-list' },
  ];
}
