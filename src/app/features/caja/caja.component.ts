...
@Component({
    ...
    <div class="tw-flex tw-flex-col tw-min-h-[calc(100vh-64px)]">
      <nav class="gp-subnav">
        <div class="gp-subnav__inner">
          <span class="gp-subnav__module"><i class="pi pi-dollar tw-text-[#10b981]"></i> Caja</span>
  ...
  styles: [`
    ...
    .gp-subnav__link--active{background:#dcfce7;color:#15803d;font-weight:600;}
  `],
})
export class CajaComponent {
  links = [
    { path: 'apertura', label: 'Apertura de Caja', icon: 'pi pi-lock-open'  },
    { path: 'cobros',   label: 'Cobros',           icon: 'pi pi-credit-card'},
    { path: 'cierre',   label: 'Cierre de Caja',   icon: 'pi pi-lock'       },
  ];
}
